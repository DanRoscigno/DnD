...
class Elk(Monster):
    """**Keen Hearing and Smell.** The elk has advantage on Wisdom
    (Perception) checks that rely on hearing or smell.
    **Pack Tactics.** The elk has advantage on an attack roll against a
    creature if at least one of the elk's allies is within 5 ft. of
    the creature and the ally isn't incapacitated.  Actions
    **Bite.** *Melee Weapon Attack:* +4 to hit, reach 5 ft., one
    target. *Hit:* (2d4+2) piercing damage. If the target is a
    creature, it must succeed on a DC 11 Strength saving throw or be
