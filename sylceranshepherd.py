"""This file describes the heroic adventurer SylceranShepherd.
...
skill_proficiencies = ('arcana', 'nature', 'athletics', 'deception', 'perception')
...
weapons = ["Quarterstaff", "Dagger", "Club", "Shortsword"]  # Example: ('shortsword', 'longsword')
