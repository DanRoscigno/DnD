...
%\backgroundsetup{           % I insert it in the "title_page.tex" file
 ...
 %angle=0,
 %opacity=.1,  %% adjust
 %contents={\includegraphics[width=\paperwidth,height=\paperheight]{img/backpack.jpg}}
 %}
%\thiswatermark{\centering \put(-50,-850){\includegraphics[scale=1.5]{img/backpack.jpg}} }
Hello
\begin{minipage}[t]{0.2\textwidth}
\backgroundsetup{           % I insert it in the "title_page.tex" file
 scale=1,
 angle=0,
 opacity=.1,  %% adjust
 contents={\includegraphics[width=\paperwidth,height=\paperheight]{img/saving.jpg}}
 }
 42
\end{minipage}
\end{document}
