...
\begin{paracol}{3}
    ...
    \includegraphics[height=8.1cm]{img/rope.png}\\
    \normalsize{50' Rope\\Grappling Hook}
    \switchcolumn
    \centering 
    \includegraphics[height=9.2cm]{img/Backpack.png}\\
    \normalsize{What's in these pocketses?\\Bedroll}
    \switchcolumn
    \centering
    \normalsize{Outside Right}\\
    \includegraphics[height=5.9cm]{img/HammerAndPitons.png}\\
    \normalsize{Hammer\\Spikes}
\end{paracol}
\vspace{1.5cm}
\begin{paracol}{3}
    \centering
    \normalsize{Inside Left}\\
    \includegraphics[height=5.9cm]{img/Scrolls-herbs.png}\\
    \normalsize{stuff for spells\\holy water\\oil\\potions}
    \switchcolumn
    \centering 
    \normalsize{Inside Back}\\
    \includegraphics[height=9.2cm]{img/CandlesTinder.png}\\
...
\end{paracol}
\newpage
\backgroundsetup{opacity=.8,contents={\includegraphics[width=\paperwidth,height=\paperheight]{img/wizard3.png}}}
Color Spray (Lvl 1)
\\
